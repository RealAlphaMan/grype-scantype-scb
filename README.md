...
## Deployment
The grype chart can be deployed via helm:

```bash
# Install HelmChart (use -n to configure another namespace)
helm upgrade --install grype secureCodeBox/grype
```
...
| parser.image.repository | string | `"docker.io/securecodebox/scanner-grype"` | Parser image repository |
...
| scanner.image.repository | string | `"docker.io/securecodebox/scanner-grype"` | Container Image to run the scan |
